            ...
            results.append(
                {
                    ...
                    "depreciation_and_amortization": _g(
                        col, "Depreciation And Amortization", "Depreciation Amortization Depletion"
                    ),
                    "stock_based_compensation": _g(col, "Stock Based Compensation"),
                    "change_in_working_capital": _g(
                        col, "Change In Working Capital", "Changes In Account Receivables"
                    ),
                    "net_cash_from_operations": op_cf,
                    "capital_expenditure": capex,
                    "acquisitions": _g(col, "Acquisitions And Disposals"),
                    "purchase_of_investments": _g(
                        col, "Purchase Of Investment", "Purchase Of Business"
                    ),
                    "sale_of_investments": _g(col, "Sale Of Investment"),
                    "net_cash_from_investing": _g(
                        col, "Investing Cash Flow", "Cash Flow From Continuing Investing Activities"
                    ),
                    ...
                    "net_cash_from_financing": _g(
                        col, "Financing Cash Flow", "Cash Flow From Continuing Financing Activities"
                    ),
