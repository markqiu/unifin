    ...
    def transform_data(raw_data: Any, query: BaseModel) -> list[dict[str, Any]]:
        ...
        for col_date in list(df.columns)[:limit]:
            ...
            results.append({
                ...
                "other_income": _g(col, "Other Income Expense", "Other Non Operating Income Expenses"),
                ...
                "total_comprehensive_income": _g(col, "Net Income Including Noncontrolling Interests"),
